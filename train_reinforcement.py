...
if __name__ == "__main__":
    ...
    # so after the start_timesteps, the agent runs with a deterministic policy
    ...
    parser.add_argument("--env_timesteps", default=500, type=int)  # Frequency of delayed policy updates <-- this is the real one
    parser.add_argument(
